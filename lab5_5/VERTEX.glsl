uniform float time;         // tr? th?i gian bi?n d?i nhi?u 
uniform float displacement; // d? m?nh c?a hi?u ?ng 
varying float noise;        // giá tr? màu cho fragment shader 
const float speed = 1.0;    // t?c d? ho?t c?nh 
const float scale = 2.0;    // t? l? vân nhi?u 
