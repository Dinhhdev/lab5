uniform float time;     // giá tr? th?i gian hi?n hành d? bi?n d?i nhi?u 
uniform vec3 shade;     // màu c?a nhi?u 
varying vec3 position;  // t?a d? d?nh t? vertex shader 
const float speed = 1.0; 
 
// B? PHÁT SINH NHI?U SIMPLEX 
vec4 permute(vec4 x) {  
